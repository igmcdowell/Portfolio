...
function portfolio() {
   ...
   this.loadContent = function(pname) {
    ...
    this.changeSlide = function(direction, projects, sections){
    ...
    this.makeProjectCarousel = function(projects) {
    ...
    this.advanceProject = function(direction, projects) {
